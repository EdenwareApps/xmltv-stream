...
const DEFAULT_TIME_FMT = 'YYYYMMDDHHmmss Z'

// main parser class for XMLTV
class XMLTVParser extends Writable {
    constructor(options = {}) {
        super()
        this.options = {
    ...
    parseDate(date) {
        ...
        return parsed.isValid() ? parsed.format(this.options.timeFmt) : null
    }
}

module.exports = { Parser: XMLTVParser, Programme }
